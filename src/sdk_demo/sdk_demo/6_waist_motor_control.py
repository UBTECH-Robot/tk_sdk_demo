...
class WaistMotorController(Node):
    ...
    def set_zero(self):
        ...
        joint_ids = ", ".join(str(motor_id) for motor_id in waist_MOTOR_IDS)
        ...
        self.get_logger().warn("✓ 请等待驱动器完成标零并手动重启本体控制服务(ros2 launch body_control body.launch.py)或直接断电重启机器人")
